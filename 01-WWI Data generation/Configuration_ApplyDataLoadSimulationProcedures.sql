...
BEGIN
	...
	IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE name = N'Logging'
											 AND SCHEMA_NAME(schema_id) = N'DataLoadSimulation')
    BEGIN 
        SET @SQL = N'
        
        CREATE TABLE DataLoadSimulation.Logging( 
        LoggingId BIGINT IDENTITY (1,1) NOT NULL,
        ParentLoggingId BIGINT NULL ,
        LoggingProcedure VARCHAR(100) NOT NULL ,
        DateLoaded DATE NOT NULL,
        StartDateTime DATETIME NOT NULL,
        EndDateTime DATETIME NULL,
        TotalDurationS AS DATEDIFF(s, StartDateTime, EndDateTime)
        )
    ';
        EXECUTE (@SQL);
	END;
...
END;';
	...
	IF NOT EXISTS (SELECT 1 FROM sys.procedures WHERE SCHEMA_NAME(schema_id) = N'DataLoadSimulation'
	                                            AND name = N'ActivateWebsiteLogons')
	BEGIN
		SET @SQL = N'
...
END;';
    ...
    IF NOT EXISTS (SELECT 1 FROM sys.procedures WHERE SCHEMA_NAME(schema_id) = N'DataLoadSimulation'
	                                            AND name = N'RecordColdRoomTemperatures_Optimised')
	BEGIN
		SET @SQL = N'
        CREATE PROCEDURE [DataLoadSimulation].[RecordColdRoomTemperatures_Optimised]
            @CurrentDateTime datetime2(7),
            @EndOfTime datetime2(7),
            @IsSilentMode bit
        WITH EXECUTE AS OWNER
        ...
        BEGIN
            ...
            DECLARE @LowerLimit INT = 2500,
                    @UpperLimit INT = 5000,
                    @StartDate DATE = CAST(@CurrentDateTime AS DATE)

            -- Get random number between 10k-20k
            DECLARE @NumberofRows BIGINT = FLOOR(RAND()*(@LowerLimit-@UpperLimit+1))+@UpperLimit;
            ...
            -- List out the sensors 
            SELECT sensorId
            INTO #sensors
            FROM  (VALUES(1), (2), (3), (4)) AS s(sensorId)
    ...
    IF NOT EXISTS (SELECT 1 FROM sys.procedures WHERE SCHEMA_NAME(schema_id) = N'DataLoadSimulation'
	                                            AND name = N'LogSubProcedure')
	BEGIN
		SET @SQL = N'
        CREATE PROCEDURE DataLoadSimulation.LogSubProcedure            
            @ParentLoggingId BIGINT,
            @LoggingProcedure VARCHAR(100),
            @DateLoaded DATE ,
            @LogId BIGINT OUTPUT
        AS
        BEGIN           
            INSERT INTO DataLoadSimulation.Logging (       
                ParentLoggingId ,   
                LoggingProcedure ,
                DateLoaded  ,
                StartDateTime 
            ) 
            SELECT @ParentLoggingId, @LoggingProcedure , @DateLoaded, GETDATE()
...
BEGIN
    ...
    -- Logging set up 
    DECLARE @LoggingProcedure VARCHAR(100)= ''DailyProcessToCreateHistory''
    ...
    BEGIN        
        ...
        SELECT @LoggingProcedure , @CurrentDateTime, GETDATE()

        DECLARE @MasterLogId BIGINT = @@IDENTITY;
    ...
    -- Purchase orders
        ...
        BEGIN
            ...
            EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''ReceivePurchaseOrders'' , @CurrentDateTime,  @LogId OUTPUT
            EXEC DataLoadSimulation.ReceivePurchaseOrders @CurrentDateTime, @StartingWhen, @EndOfTime, @IsSilentMode;
            UPDATE DataLoadSimulation.Logging SET EndDateTime = GETDATE() WHERE LoggingId = @LogId
        END;
    ...
    -- Password changes
        ...
        EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''ChangePasswords'' , @CurrentDateTime,  @LogId OUTPUT
    ...
    -- Activate new website users
        ...
        EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''ActivateWebsiteLogons'' , @CurrentDateTime,  @LogId OUTPUT
    ...
    -- Payments to suppliers
        ...
        BEGIN
            ...
            EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''PaySuppliers'' , @CurrentDateTime,  @LogId OUTPUT
    ...
    -- Customer orders received
        ...
        EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''CreateCustomerOrders'' , @CurrentDateTime,  @LogId OUTPUT
    ...
    -- Pick any customer orders that can be picked
        ...
        EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''PickStockForCustomerOrders'' , @CurrentDateTime,  @LogId OUTPUT
    ...
    -- Process any payments from customers
        ...
        BEGIN
            ...
            EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''ProcessCustomerPayments'' , @CurrentDateTime,  @LogId OUTPUT
    ...
    -- Invoice orders that have been fully picked
        ...
        EXEC DataLoadSimulation.LogSubProcedure @MasterLogId,  ''InvoicePickedOrders'' , @CurrentDateTime,  @LogId OUTPUT
    ...
    -- Place supplier orders
        ...
        BEGIN
            ...
            EXEC DataLoadSimulation.LogSubProcedure @MasterLogId,  ''PlaceSupplierOrders'' , @CurrentDateTime,  @LogId OUTPUT
    ...
    -- End of quarter stock take
        ...
        BEGIN
            ...
            EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''PerformStocktake'' , @CurrentDateTime,  @LogId OUTPUT
    ...
    -- Record invoice deliveries
        ...
        EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''RecordInvoiceDeliveries'' , @CurrentDateTime,  @LogId OUTPUT
    ...
    -- Add customers
        ...
        BEGIN
            ...
            EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''AddCustomers'' , @CurrentDateTime,  @LogId OUTPUT
     ...
     -- Add stock items
        ...
        EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''AddStockItems'' , @CurrentDateTime,  @LogId OUTPUT
    ...
    -- Add special deals
        ...
        EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''AddSpecialDeals'' , @CurrentDateTime,  @LogId OUTPUT
     ...
     -- Temporal changes
        ...
        EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''MakeTemporalChanges'' , @CurrentDateTime,  @LogId OUTPUT
    ...
    -- Record delivery van temperatures
        ...
        BEGIN
            ...
            EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''RecordDeliveryVanTemperatures'' , @CurrentDateTime,  @LogId OUTPUT
    ...
    -- Record cold room temperatures
        ...
        BEGIN
            IF @UseCustomVersion =1
            BEGIN
                EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''RecordColdRoomTemperature_Optimised'' , @CurrentDateTime,  @LogId OUTPUT
                EXEC DataLoadSimulation.RecordColdRoomTemperatures_Optimised @CurrentDateTime, @EndOfTime, @IsSilentMode;
            ...
            BEGIN
                ...
                EXEC DataLoadSimulation.LogSubProcedure @MasterLogId, ''RecordColdRoomTemperatures'' , @CurrentDateTime,  @LogId OUTPUT
        ...
        -- Close off the logging
        UPDATE DataLoadSimulation.Logging 
            SET EndDateTime   = GETDATE()
        WHERE LoggingId = @MasterLogId
